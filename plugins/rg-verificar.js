...
let handler = async function (m, { conn, text, args, usedPrefix, command }) {
    ...
    let perfil = await conn.profilePictureUrl(whe, 'image').catch(_ => 'https://i.postimg.cc/MTj28pQQ/IMG-20250502-WA0146.jpg')
...
regbot += `Usa *#perfil* para ver tu perfil.`
  ...
  await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                title: 'ＲＥＧＩＳＴＲＡＤＯ 💫',
                thumbnailUrl: 'https://i.postimg.cc/fWjqSdDb/file-00000000734c61f7ad40b87f0b7b21b0.png',
                mediaType: 1,
