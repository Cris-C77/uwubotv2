...
//creador y otros
global.creador = 'Wa.me/50670257898'
global.ofcbot = `${conn.user.jid.split('@')[0]}`
global.asistencia = 'Wa.me/573025902495'
global.namechannel = '𝙐 𝙬 𝙐 𝙨 𝘽 𝙤 𝙩'
global.namegrupo = '𝙐 𝙬 𝙐 𝙨 𝘽 𝙤 𝙩 v¹'
global.namecomu = '𝙏𝙃𝙀 𝙐𝙒𝙐𝘽𝙊𝙏 𝘾𝘼𝙉𝘼𝙇'
global.listo = '🐈 ＡＱＵＩ ＴＩＥＮＥＳ '
global.fotoperfil = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.postimg.cc/qBWCp6Vm/Logo-Uw-Usbot.png')

//Ids channel
global.idchannel = '120363312092804854@newsletter'
global.canalIdM = ["120363312092804854@newsletter"]
global.canalNombreM = ["𝙐 𝙬 𝙐 𝙨 𝘽 𝙤 𝙩"]
...
var git = '' 
var github = '' 
let correo = 'lalinlario@gmail.com'
...
global.icono = [ 
'https://i.postimg.cc/qBWCp6Vm/Logo-Uw-Usbot.png',
].getRandom()
